...
It also includes `fd` from fd 10.4.2 and `jq` from jq 1.8.2.
...
- https://github.com/sharkdp/fd/blob/master/LICENSE-MIT
- https://github.com/sharkdp/fd/blob/master/LICENSE-APACHE
