...
type ConfigOverrides = Partial<OpenAIResponsesIngressConfig> & {
  readonly execute?: (input: OneRoundModelDispatchInput) => Promise<{ readonly result: ModelTurnResult }>;
