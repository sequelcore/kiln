...
export function encodeCodexOAuthResponsesRequest(input: OneRoundModelDispatchInput): WireRecord {
...
export class CodexOAuthModelTurnDispatcher implements OneRoundModelDispatcher {
  readonly #account: ExecutionAccountRef; readonly #credential: CodexOAuthResolvedCredential; readonly #fetch: typeof fetch; readonly #sseLimits: CodexOAuthSseLimits;
