...
function config(): ModelGatewayConfig {
  return {
    ...
    virtualModels: [{ id: "model-a", displayName: "Model A", contextTokens: 200_000, outputTokens: 8_192, providerId: "codex-oauth", providerModelId: "upstream", accountIds: ["account"], capabilities: ["text"], affinity: { continuity: "none" } }],
  };
}
