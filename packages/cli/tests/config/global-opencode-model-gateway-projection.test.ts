...
function config(): ModelGatewayConfig {
  return {
    ...
    principals: [{ tokenEnv: "OPENCODE_TOKEN", ingress: "openai-responses", tenantId: "tenant", applicationId: "opencode", callerId: "caller", capabilityId: "invoke", scopes: ["model.invoke"], virtualModelIds: ["model-a"], nativeHarness: "opencode" }],
