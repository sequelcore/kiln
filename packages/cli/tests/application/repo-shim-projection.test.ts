...
describe("repo-shim-projection", () => {
  ...
  it("generates signed AGENTS.md and CLAUDE.md repo shims from real repo evidence", async () => {
    ...
    expect(agents).toContain("target: agents-md");
    ...
    expect(agents).toContain("sequel-engineering (global): C:/Users/test/.kiln/instructions/sequel-engineering.md");
    expect(claude).toContain("kiln:repo-shim:v1");
    expect(claude).toContain("target: claude-md");
