...
import { makeOperatorSurfaceGlobalConfig } from "../../tests/commands/operator-surface-config-fixture.js";
...
describe("config-merger", () => {
  ...
  it("denies project permission leaves with no global permission ceiling", () => {
    ...
    expect(() => deriveEffectiveKilnYaml({ version: "7" } as KilnGlobalConfig, projectConfig)).toThrow(
