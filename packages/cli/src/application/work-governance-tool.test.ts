    ...
    const candidateEvidence = createBoundedWorkCandidateEvidence({
      ...
      attestation: {
        ...
        payload: formalVerificationToolMetadata({
          ...
          checks: [{ symbol: "test", check: "correctness", outcome: "proved", durationMs: 0, resourceCount: 0 }],
        }),
      },
  ...
  return createBoundedWorkCandidateEvidence({
    ...
    attestation: {
      ...
      payload: formalVerificationToolMetadata({
        ...
        subjects: [{ path: "packages/cli", contentDigest: testSubjectDigest }],
        checks: [{ symbol: input.symbol, check: "correctness", outcome: "proved", durationMs: 0, resourceCount: 0 }],
      }),
    },
  ...
  return {
    ...
    observations: [{
      metadata: formalVerificationToolMetadata({
        ...
        artifact: { contentDigest: `sha256:${"c".repeat(64)}` },
        subjects: [{ path: "packages/cli", contentDigest: testSubjectDigest }],
        checks: [{ symbol: "finish", check: "correctness", outcome: "proved", durationMs: 0, resourceCount: 0 }],
      }),
