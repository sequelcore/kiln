...
{ model: "minimax-m2.5", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "high" },
    { model: "minimax-m2.7", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "high" },
    { model: "glm-5", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "glm-5.1", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "kimi-k2.5", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "kimi-k2.6", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "mimo-v2-pro", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "mimo-v2-omni", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "mimo-v2.5-pro", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "mimo-v2.5", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "qwen3.5-plus", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "qwen3.6-plus", provider: "opencode-go", inputPer1M: 0, outputPer1M: 0, qualityTier: "medium" },
    { model: "anthropic/claude-opus-4-6", provider: "opencode-zen", inputPer1M: 0, outputPer1M: 0, qualityTier: "high" },
    { model: "anthropic/claude-sonnet-4-6", provider: "opencode-zen", inputPer1M: 0, outputPer1M: 0, qualityTier: "high" },
    { model: "openai/gpt-5.4", provider: "opencode-zen", inputPer1M: 0, outputPer1M: 0, qualityTier: "high" },
    { model: "google/gemini-2.5-pro", provider: "opencode-zen", inputPer1M: 0, outputPer1M: 0, qualityTier: "high" },
  // Local
