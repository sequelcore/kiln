...
/** Opaque vocabulary only. Construction, hashing, time, and storage belong to adapters. */
...
export function commitModelGatewayReplayClaim<T>(
  claim: ModelGatewayReplayClaim<T>,
  fence: ModelGatewayReplayFence,
): ModelGatewayReplayClaim<T> {
...
export function settleModelGatewayReplayClaimUnknown<T>(
  claim: ModelGatewayReplayClaim<T>,
  fence: ModelGatewayReplayFence,
): ModelGatewayReplayClaim<T> {
  requireFence(claim, fence);
...
export function completeModelGatewayReplayClaim<T>(
  claim: ModelGatewayReplayClaim<T>,
  fence: ModelGatewayReplayFence,
  value: T,
): ModelGatewayReplayClaim<T> {
...
export function abandonModelGatewayReplayClaim<T>(
  claim: ModelGatewayReplayClaim<T>,
  fence: ModelGatewayReplayFence,
): undefined {
  requireFence(claim, fence);
