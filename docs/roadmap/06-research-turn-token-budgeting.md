...
- Reuse roadmap `08` measurement and control primitives instead of creating a
...
- No separate research policy owner outside roadmap `08` control-plane
  contracts.
...
producing a correct, cited answer. Roadmap `08` now owns the wider efficiency
...
2. Attribute research-turn tokens by lifecycle source using roadmap `08`
   primitives.
