...
| [05-trusted-execution-integrity.md](./05-trusted-execution-integrity.md) | Active; Slice 2 complete | Native projection now carries trusted-execution evidence for Codex, Claude Code, and OpenCode, including lossy translation and OpenCode sandbox limitations. | Start Slice 3 runtime and managed-agent authority evidence. |
