...
| --- | --- | --- | --- | --- |
| 1 | [12 - Configuration Experience](12-configuration-experience.md) | In progress | Urgent | Start Slice 4: configuration mutation authority V2; preserve the economic and managed-agent intent boundary for Slice 7A. |
