...
| --- | --- | --- | --- | --- |
| 1 | [12 - Configuration Experience](12-configuration-experience.md) | In progress | Urgent | Execute Slice 5: prove a minimal guided CLI first turn without YAML, with idempotent cancellation-safe adoption through the Slice 4 authority. |
