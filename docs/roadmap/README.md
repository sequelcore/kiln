...
| --- | --- | --- | --- | --- |
| 1 | [12 - Configuration Experience](12-configuration-experience.md) | In progress | Urgent | Start Slice 1: replace the project YAML structural type and partial validator with the admitted TypeBox schema and inferred type. |
