...
| --- | --- | --- | --- | --- |
| 1 | [12 - Configuration Experience](12-configuration-experience.md) | In progress | Urgent | Finish the property-level ownership ledger and ADR-012 compatibility fixture; ADR-014/015 and the project-schema mechanism spike are complete. |
