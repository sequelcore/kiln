...
| --- | --- | --- | --- | --- |
| 1 | [12 - Configuration Experience](12-configuration-experience.md) | In progress | Urgent | Start Slice 3: separate execution-target intent from generated policy, economics, discovery, freshness, and projection evidence. |
