...
| [05-trusted-execution-integrity.md](./05-trusted-execution-integrity.md) | Active; Slice 3 complete | Runtime managed-agent execution now separates requested, projected, and observed child authority, fails closed for unproven or mismatched unattended execution, and rechecks replay freshness. | Start Slice 4 doctor and shared operator surfaces. |
