...
| --- | --- | --- | --- |
| 1 | [02 - Managed Invocation Routing](02-managed-invocation-routing.md) | Ready | Issue #34 internal Slice 5 dispatch was reviewed post-delivery and had two High findings (H1/H2) plus five Medium/Low findings, all now fixed. Internal Slice 5 delivered a bounded start on Slice 6 (Runtime canonical economic events proven to the Gateway-contracts frame boundary); remaining Slice 6 work is the full durable-lifecycle fixture and CLI/GUI/TUI/Native/SDK/MCP projection parity. |
