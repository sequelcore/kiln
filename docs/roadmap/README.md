...
| --- | --- | --- | --- | --- |
| 1 | [12 - Configuration Experience](12-configuration-experience.md) | In progress | Urgent | Execute Slice 6: build the searchable cross-surface settings foundation on the completed descriptor, projection, mutation, and onboarding contracts. |
