...
- `packages/runtime/src/voice/stt/openai-stt.ts`
- `packages/runtime/src/voice/stt/deepgram-stt.ts`
- `packages/runtime/src/voice/tts/openai-tts.ts`
- `packages/runtime/src/voice/tts/elevenlabs-tts.ts`
- `packages/runtime/src/voice/stt-factory.ts`
- `packages/runtime/src/voice/tts-factory.ts`
- `packages/runtime/src/voice/local-voice-adapters.ts`
...
- `packages/runtime/tests/voice/stt/openai-stt.test.ts`
- `packages/runtime/tests/voice/stt/deepgram-stt.test.ts`
- `packages/runtime/tests/voice/tts/openai-tts.test.ts`
- `packages/runtime/tests/voice/tts/elevenlabs-tts.test.ts`
- `packages/runtime/tests/voice/stt-factory.test.ts`
- `packages/runtime/tests/voice/tts-factory.test.ts`
- `packages/runtime/tests/voice/local-voice-adapters.test.ts`
...
- `packages/cli/tests/config/operator-voice.test.ts`
