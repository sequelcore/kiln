...
[`docs/architecture/provider-credential-pools.md`](../../architecture/safety/provider-credential-pools.md).
...
- [Provider Model Discovery](../../architecture/providers/provider-model-discovery.md)
