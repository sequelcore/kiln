...
| `computer_close_application` | Gracefully close a governed desktop app/window | `application`, `windowTitle`, `timeout`, `verbosity` | destructive lifecycle evidence; captures and reports the requested target, verifies it closed, and does not force-kill |
