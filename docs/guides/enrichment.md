...
- [Model Routing](model-routing.md) -- per-request model selection
- [Multi-Tenant](multi-tenant.md) -- tenant configuration
- [Observability](observability.md) -- metrics and event infrastructure
