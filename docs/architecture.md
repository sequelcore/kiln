...
| `tenant` | `@kilnai/runtime` | `packages/runtime/src/tenant/` | Multi-tenant management: TenantRegistry (webhook tool secret encryption), system prompt builder, phone-to-tenant resolution. |
