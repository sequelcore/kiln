...
import { accessPolicy } from "./fixtures/lemma-script-qualification-v1/access-policy.js";
...
function readCaseManifest(): CaseManifest {
  const parsed: unknown = JSON.parse(
    readFileSync(new URL("./fixtures/lemma-script-qualification-v1/cases.json", import.meta.url), "utf8"),
  );
  if (
    !isRecord(parsed) ||
